...
public:
	 ...
	 */
	virtual operator std::unordered_map<std::string const, EPTR(ITerm)>() const = 0;
	 ...
	 */
	virtual EPTR(ITerm) get_bind(std::string const& name) = 0;
	 ...
	 */
	virtual std::unordered_set<EPTR(ITerm)> get_elements() const = 0;
};
